...
INSERT INTO lots (user_id, title, category_id, description, img_path, start_date, start_price, end_date, bet_step)
VALUES (1, 'Маска Oakley Canopy', 6, 'Увеличенный объем линзы и низкий профиль оправы маски Canopy способствуют широкому углу обзора, а специальное противотуманное покрытие поможет ориентироваться в условиях плохой видимости.', 'img/lot-6.jpg', '2018-09-26 11:30:00', 5400, '2018-09-27 11:30:00', 300);
